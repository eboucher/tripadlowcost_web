...
export default function (ctx, inject) {
  ...
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"auth/local","method":"post","propertyName":"jwt"},"logout":false,"user":{"url":"users/me","method":"get","propertyName":""}},"_name":"local"}))
