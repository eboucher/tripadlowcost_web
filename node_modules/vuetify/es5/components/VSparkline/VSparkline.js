...
exports.default = (0, _mixins2.default)(_colorable2.default).extend({
    ...
    methods: {
        ...
        genClipPath: function genClipPath(offsetX, lineWidth, id) {
            ...
            var negative = Math.min.apply(Math, _toConsumableArray(this.points.map(function (x) {
                return x.value;
            }))) < 0;
            var maxY = this.boundary.maxY;

            var rounding = typeof this.smooth === 'number' ? this.smooth : this.smooth ? 2 : 0;
            var zero = (0, _core.genPoints)([0].concat(_toConsumableArray(this.value)), this.boundary, this.type)[0].y;
            return this.$createElement('clipPath', {
                ...
                var height = 0;
                if (negative && item.value > 0) height = zero - item.y;else if (!negative || item.value < 0) height = maxY - item.y;
