...
var baseMixins = (0, _mixins2.default)((0, _registrable.inject)('expansionPanel', 'v-expansion-panel-header', 'v-expansion-panel'));
exports.default = baseMixins.extend().extend({
    ...
    methods: {
        ...
        genIcon: function genIcon() {
            var icon = (0, _helpers.getSlot)(this, 'actions') || [this.$createElement(_VIcon2.default, this.expandIcon)];
    ...
    render: function render(h) {
        ...
        }, [(0, _helpers.getSlot)(this, 'default', { open: this.isActive }, true), this.hideActions || this.genIcon()]);
    }
});
